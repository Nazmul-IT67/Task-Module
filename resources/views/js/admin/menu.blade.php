                    ...
                    if (data.status == true) {
                        ...
                        if (data.menuItem.menu_type == "custom") {
                           ...
                           <div class="form-inner mb-3">
                                <label class="form-label"> {{ translate('Custom Link') }} <span>*</span></label>
                                <input type="text" class="form-control" id="custom_link" value ="${data.menuItem.target}" name="custom_link"
                                placeholder="https://">
                            </div>
